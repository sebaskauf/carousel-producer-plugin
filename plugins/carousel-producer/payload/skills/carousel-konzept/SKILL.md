...
Deshalb steckt Sebastians Geschmack (Value-first, Audience, Voice, Bogen) in diesem Skill.

## Audience (fuer wen)
AI/Claude-Code-Builder, Solo-Founder und Selbststaendige, SKAILE-Academy-Member. Sie wollen konkret
besser/schneller/eigenstaendiger bauen. Sie riechen Marketing-Geschwafel sofort. Sie belohnen: ein
klares Aha, ein konkretes Vorgehen, ein ehrliches "so mach ich das". Sie bestrafen: Buzzwords,
Overclaim, "Game-Changer"-Sprache, Text ohne Substanz.
...
- **Eigenstaendigkeit:** Kann Sebastian glaubwuerdig "so mach ich das" sagen (echte Praxis > Theorie)?
...
(Single-Shot-Artefakte o.ae.) lieber den belastbaren Wert + "bis zu" als den Fake. Im Zweifel Sebastian
kurz den Tradeoff nennen (sein No-Overclaim-Prinzip vs. plakativ).
...
- **cta** — der konkrete naechste Schritt (academy.skaile.de Warteliste, "folg fuer mehr", etc.).
...
Nutze den `tone-of-voice`-Skill. Sebastian-Stil: direkt, kurze Saetze, konkret, kein Corporate, keine
Em-Dashes, echte Umlaute, "ich"-Perspektive wo es passt. Pro Slide: kurzer Kicker, knackige Headline
...
```json
{
  ...
  "slides": [
    ...
    { "n": 6, "pattern": "cta", "kicker": "Dein Zug", "headline": "...", "cta": "academy.skaile.de",
